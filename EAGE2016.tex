...
%%
%% Wanderson, modifiquei essa parte, pois esses valores nao sao ou serao 
%%constantes. Acho melhor deixar a informacao sem os numeros.
%%The forward modelling algorithm has shown excellent performance to be 
%%used in global optimization schemes being able to compute more than 
%%300.000 synthetic seismograms in less than 30 minutes.
\end{abstract}
...
\subfigbottomskip0pt
\subfigure[]{
    \includegraphics[width=0.49\textwidth]{evolution-sol-constrains}
    \label{fig2-with} 
}
\subfigure[]{
    \includegraphics[width=0.49\textwidth]{evolution-sol-no-constrains}
    \label{fig2-without} 
}
