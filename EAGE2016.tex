...
For this simple model, we created a synthetic data set
%using XXX modeling %AQUI FALTA DIZER COMO FOI MODELADO ???
with
a zero-phase
Ricker wavelet with central frequency of 40~Hz and time sample
...
To study the quality of the inversion, we concentrate on the
...
recovered with and without the constrains in the
