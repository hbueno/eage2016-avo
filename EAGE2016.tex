...
\cite{Stoffa1991} and \cite{Sen1992} and using the \cite{Gardner1974} and
\cite{Castagna1975} empirical relationships as constrains to verify the
dependency among the parameters.
