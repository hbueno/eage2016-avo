...
time arrival inside the trace.The algorithm is simple and provides the opportunity to be
...
\caption{Model parameters used for the forward modelling.}
...
population and a convergence criterion of 200 iterations. In the
following results is shown only the parameters for the fourth
layer of the model in Table~\ref{tab.model}. Figure~\ref{fig2} shows the evolution of the genetic
...
\caption{Recovered parameters for the model presented in Table 1 with
and without the constrains.}
